...
Public API (0.1.0 surface, unchanged; 0.2.0 activated ``platform`` and
added registry metadata; 0.3.0 activates ``parsed`` and ``profile``):
...
* ``parsed`` (active since 0.3.0) — rows another parser (Genie,
  ...
  everything else.
* ``profile`` (active since 0.3.0) — a named, opt-in, DECLARED-lossy
