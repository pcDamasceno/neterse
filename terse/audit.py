...
* ``platform-skip:<entry>`` — patterns matched but the platform filter
  ...
  not a gap; new in the 0.2.0 registry).

Conventions inherited verbatim from the first consumer's ledger
(docs/CONSUMER-HANDOFF.md §3) so both ends agree: chars/4 per token,
